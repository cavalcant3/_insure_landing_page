...
import ImgLogFot from "./images/logo.svg";
...
function App() {
  return (
    <div className="App">
      ...
      <div className="card">
        <div className="card__text">
          ...
          <p className="card__subtitle">
            ...
            experties
            <br /> and technology to help you to find the plan that's right{" "}
            <br />
      ...
      <div className="body__svg__right">
      ...
      <section className="bannerfim">
        <div className="bannerfim__grid">
          <h1 className="bannerfim__h1">
            Find out more <br />
            about how we work
          </h1>
      ...
      <section className="footer">
        <div className="socialinks">
          <div className="logo">
            <img src={ImgLogFot} alt="logofoot" />
          </div>
          <div className="links">
      ...
      <div class="attribution">
        ...
        Coded by{" "}
        <a href="https://github.com/cavalcant3" target="_blank">
          Matheus Cavalcante
        </a>
        .
      </div>
